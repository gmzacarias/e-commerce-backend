...
describe("test in dateFns", () => {
    it('should convert a Firebase timestamp to a Date object', () => {
        const input = {
            _seconds: 946655400,
    ...
    it('should check the expiration payments and return un number', () => {
        jest.useFakeTimers()
        jest.setSystemTime(new Date('2025-06-29T22:00:00Z'))
        expect(typeof checkExpirationPayments(new Date())).toBe("number")
    })

    it('should convert to Date and format as ISO 8601 string', () => {
